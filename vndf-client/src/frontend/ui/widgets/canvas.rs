use crate::{
    frontend::{
        ...
        ui::{
            ...
            input::Input,
            traits::{Draw, DrawAt, DrawError, ProcessInputAt, Size},
        },
    },
    graphics,
};
...
impl Canvas {
    ...
    pub fn add_at<E>(&mut self, element: E, position: graphics::Pnt2)
    where
        E: Element + 'static,
    {
    ...
    pub fn add_anchored<E>(&mut self, element: E, anchor: Anchor, frame: &Frame)
    where
        E: Element + Size + 'static,
    {
